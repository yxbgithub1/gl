<template>
    <div class="scroll" :class="{'pull-down': (state === 0),'pull-up': (state === 1),refreshing: (state === 2),touching: touching}"
        ...
        <div class="pull-to-refresh-layer" v-if="!!onRefresh">
            <slot name="refresh">
                ...
                <span class="label-up">松开立即刷新</span>
                <span class="label-refresh">正在刷新数据...</span>
            </slot>
        </div>
    ...
    export default {
      ...
      data () {
          return {
            ...
            noInfinite:this.enableInfinite
          }
      },
      methods: {
            touchStart (e) {
